...
<body>
    ...
    <form action="payapi.php" method="post" class="body-canvas">
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="trans_amount" value="0.01">
            </div>
        </div>
        ...
        <div>
            <h2><span class= "red-required">*</span>Browser Type</h2>
				<select class="payment-dropdown" name="browser_type">
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="out_order_no"value="<?php echo $orderId ?>">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="notify_url" value="http://<?php echo $hostname ?>/demo_1_0_1/aliwebpay/Aliweb-source.php">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="return_url" value="http://<?php echo $hostname ?>/demo_1_0_1/aliwebpay/returnurl.php?out_order_no=<?php echo $orderId ?>">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="description" value="mobile-shopping-phptest">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="entry-box">
                <input type="text" name="merchant_no" value="901800002555">
            </div>
        </div>
