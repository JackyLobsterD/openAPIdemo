...
<body>
    ...
    <form action="refundorder.php" method="post" class="body-canvas">


        <h1>Refund Order</h1>
		
		<div>
            <h2><span class= "red-required">*</span>Refund Amount</h2>
            <div class="entry-box">
                <input type="text" name="refund_amount" value="0.01">
            </div>
        </div>
        ...
        <div>
            <h2><span class= "red-required">*</span>Out Refund No.</h2>
            <div class="entry-box">
                <input type="text" name="out_refund_no" value="<?php echo $orderId ?>">
            </div>
        </div>
        ...
        <div>
            <h2><span class= "red-required">*</span>App ID</h2>
            <div class="entry-box">
